...
├─ GameForge Program
│  ├─ Role 1: Educational mentorship
│  ├─ Role 2: Community building
│  └─ Role 3: Talent vetting
│
AETHEX.DEV (For-Profit)
├─ GameForge Workspace (Dashboard)
├─ NEXUS (Marketplace)
│  └─ Hires "Architects" from GameForge
├─ LABS (R&D)
│  └─ Licenses beta tech to GameForge for testing
└─ CORP (Enterprise Services)
   └─ Sells verified "Architects" and battle-tested IP to clients
```
